      ...
      <div className="girdcontainer">
        <div className="cardBox">
          ...
          <div className="cardCont">
            ...
            <p>
              SDProctor helps prevent and identify instances of cheating during
              assessments. Their presence ensures that students are evaluated
              fairly.
            </p>
          </div>
        </div>
        ...
        <div className="cardBox">
          ...
          <div className="cardCont">
            <h2>Accessibility</h2>
            <p>
              SDproctor offer services that make it easy for students to take
              exams and assessments from wherever they are.{' '}
            </p>
          </div>
        </div>
